...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'图书处理',items:[{id:'12',text:'借书处理',href:'<%=request.getContextPath()%>/admin/show'},{id:'3',text:'归还处理',href:'<%=request.getContextPath()%>/admin/backBooks'},{id:'4',text:'预定处理',href:'<%=request.getContextPath()%>/admin/showReserveBook'}]}]}];
